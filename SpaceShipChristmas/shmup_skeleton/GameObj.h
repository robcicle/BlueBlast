...
struct GameObj
{
	...
	enum class ObjectT { Ship, Rock, Bullet, Enemy };	//what is this object instance?
	...
	GameObj *pMySpawner = nullptr;	//if I am a bullet, then some other object fired me off (player or enemy?)
