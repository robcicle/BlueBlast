...
struct Metrics {
	...
	*/
	...
	// Load and save from the .db file
...
/* Function used to load textures in, made to shorten repition
file - Path and File name and extension to find the texture
tex - Use the texture you wish to load in
*/
